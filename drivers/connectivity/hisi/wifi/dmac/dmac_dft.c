...
{
    oal_int32       l_adc_pin_phy;       /* ??phy??????????????????adc????????????????????0.25dB */

    /* ul_adc_pin_code_rpt????9bit????ADC??????????????????????0.25dB,??????????
       ????????????
    */
...
{
    oal_uint32          ul_adc_pin_code_rpt;       /* PHY bank2 ADC_PIN_CODE_RPT?????????? */
    oal_int32           l_adc_pin = 0;
    oal_int32           l_extlna_gain = 0;             /* ????LNA???? */
    oal_int32           l_intlna_gain = 0;             /* ????LNA???? */
    oal_int32           l_vga_gain = 0;                /* VGA???? */
    oal_int32           l_reference0 = 0;              /* ???????????????????????? */

    /* phy??????????????????: adc_pin - (extlna_gain + intlna_gain + vga_gain + reference_0)*/
