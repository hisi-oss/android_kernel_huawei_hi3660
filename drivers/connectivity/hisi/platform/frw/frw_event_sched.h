...
/*****************************************************************************
  ??????  : frw_event_queue_state_enum_uint8
  ????????:
  ????????: ????????????
*****************************************************************************/
typedef enum
...
/*****************************************************************************
  ??????  : frw_vap_state_enum_uint8
  ????????:
  ????????: ????????????
*****************************************************************************/
typedef enum
{
    FRW_VAP_STATE_RESUME  = 0,    /* VAP???? */
    FRW_VAP_STATE_PAUSE,          /* VAP???? */
...
typedef struct tag_frw_event_queue_stru
{
    ...
    oal_uint8                           uc_weight;      /* WRR?????????? */
    oal_uint8                           uc_weight_cnt;  /* WRR?????????? */

    frw_vap_state_enum_uint8            en_vap_state;   /* VAP??????????0????????1?????? */
