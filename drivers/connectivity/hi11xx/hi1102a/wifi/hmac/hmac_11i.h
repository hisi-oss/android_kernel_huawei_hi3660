...
oal_uint32 hmac_check_rsn_capability(mac_vap_stru *pst_mac_vap, mac_user_stru *pst_mac_user, const oal_uint8 *puc_rsn_ie, mac_status_code_enum_uint16 *pen_status_code);
