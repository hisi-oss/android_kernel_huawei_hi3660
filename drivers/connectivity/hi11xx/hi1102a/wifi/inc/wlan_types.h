...
typedef enum
{
    WLAN_EXTLNA_BYPASS_EN_OFF      = 0, /* ????bypass????LNA?????? */
    WLAN_EXTLNA_BYPASS_EN_ON       = 1, /* ????bypass????LNA?????? */
    WLAN_EXTLNA_BYPASS_EN_FORCE    = 2, /* ??????????????????????LNA */
    WLAN_EXTLNA_BYPASS_EN_SCANNING = 3, /* ??????????????????bypass????LNA????(????????????????) */
