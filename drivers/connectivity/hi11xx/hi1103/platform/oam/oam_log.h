...
#define OAM_ONT_LOG_DEFAULT_EVENT       HW_KER_WIFI_LOG_BUTT        //????????????ont proc log
...
typedef enum
{
    HW_KER_WIFI_LOG_CONFIG = 0, /*????????*/
    HW_KER_WIFI_LOG_CONNECT,    /*????????*/
    HW_KER_WIFI_LOG_CMDOUT,     /*????????????*/
    HW_KER_WIFI_LOG_CHANNEL,    /*?????????????????????????????????????????????????????????? */
    HW_KER_WIFI_LOG_COLLISION,  /*BSSID ????????*/
