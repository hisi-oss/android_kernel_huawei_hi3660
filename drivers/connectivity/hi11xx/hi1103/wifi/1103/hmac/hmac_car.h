...
/*****************************************************************************
  2 ??????
*****************************************************************************/
#define HMAC_CAR_CYCLE_MS               100         //CAR??????????????????ms
#define HMAC_CAR_WIFI_ETH               20          //??????????20????????wifi 34(26+8), eth 14(6+6+2); wifi-eth;??eth????
#define HMAC_CAR_MULTICAST_PPS_NUM      0          //CAR????????pps??????:0??????????pps??????>0??????pps??????????
