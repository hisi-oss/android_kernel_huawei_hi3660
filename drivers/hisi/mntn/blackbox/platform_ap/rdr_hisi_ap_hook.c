...
Description:	??????????????????
Input:		    pre_task:????????task????????????next_task:??????????task????????????
Output:		    NA
Return:		    NA
...
{
	/* ??????????cpu_id??next_task??pid????????????????cpu??????buffer?? */
...
Description:     ????tasklet ????????
Input:		    address:??tasklet ??????function?? address, dir:??????????????0:??????1:????
Output:		    NA
Return:		    NA
Other:          added to arch/arm64/kernel/entry.S
********************************************************************************/
...
Description:     ????worker????????
Input:		    address:??worker ??????function?? address, dir:??????????????0:??????1:????
Output:		    NA
Return:		    NA
Other:          added to arch/arm64/kernel/entry.S
********************************************************************************/
