...
/*  2042  */    en_NV_Item_START_AND_STOP_CONT_DTMF_INTERVAL    = 2042,     /* StopContDtmfReq??StartContDtmfReq???????????? */
...
/*  2059  */    en_NV_Item_1X_SERVICE_CL_SYSTEM_ACQUIRE_STRATEGY_CFG = 2059, /* 1x????????CL???????????????? */

/*   2060*/      en_NV_Item_PPP_AUTH_INFO_FROM_CARD_FLAG = 2060,       /* 1X HRPD PPP????????????????????????card */


/* 2062 */       en_NV_Item_1X_POWER_OFF_CAMP_ON_CTRL = 2062,
/*  2063  */     en_NV_Item_CL_NO_SERVICE_DELAY_RPT_CFG  = 2063,       /* ????????HRPD??LTE???????????????????? */

/* 2064 */       en_NV_Item_NDIS_FILTER_ENABLE_FLAG_CFG = 2064,
/* 2065  */     en_NV_Item_1X_OOS_SYS_ACQ_STRATEGY_CFG   = 2065,       /* 1x OOS????????????????????NV */
/*  2066  */    en_NV_Item_CL_SYSTEM_ACQUIRE_DSDS_STRATEGY_CFG = 2066,  /* CL????????DSDS???????? */

/*  2067  */    en_NV_Item_CTCC_OOS_CFG = 2067,  /* ???????? OOS?????????? */

/*  2068  */    en_NV_Item_CDMA_ERR_LOG_ACTIVE_REPORT_CONTROL = 2068,         /* X??CHR???????????? */

/*  2069  */    en_NV_Item_1X_DO_SYS_ACQ_NO_RF_PROTECT_TIMER_CFG = 2069,  /* SRLTE??1x DO?????????????? ?????????? */

/* 2070 */       en_NV_Item_HOME_MCC_INFO = 2070,

/*  2071  */    en_NV_Item_HRPD_AVOID_SCHEDULE_INFO = 2071,  /* ????avoid???? */

/*  2073  */    en_NV_Item_GET_DNS_TROUGH_DHCP_CFG = 2073,              /* ????????????DHCP????DNS */
/*  2074  */    en_NV_Item_MRU0_SWITCH_ON_OOC_STRATEGY_CFG = 2074,  /* ??????OOC??????MRU0???????? */
/*  2075  */    en_NV_Item_1X_PRL_ROAM_IND_STRATEGY_CFG = 2075,         /* ????1X PRL??????????????????????ROAM IND???? */

/*  2076  */    en_NV_Item_SYS_ACQ_BSR_CTRL_CFG = 2076,  /* BSR TIMER ???????? */

/*  2077  */    en_NV_Item_1X_SYS_ACQ_SYNC_DELAY_INFO_WHEN_LTE_OR_DO_CONN = 2077,         /* hrpd ?????????????? srlte??lte????????????1x?????????????????????????????????????? */

/*  2079  */    en_NV_Item_CDMA_1X_CUSTOMIZE_PREF_CHANNELS_INFO = 2079,         /* 1X??????????????????????????????10????????20?? */

/*  2080  */    en_NV_Item_CDMA_HRPD_CUSTOMIZE_PREF_CHANNELS_INFO = 2080,         /* HRPD????????????????????????20?? */
...
/* 2088 */      en_NV_Item_1X_CS_CALL_REDIR_CMPL_DELAY_TIMER_INFO = 2088,         /* ????????????????????????????XCALL??????????????????????????????????????????????NV */
...
/* 2096 */      en_NV_Item_LTE_OOS_DELAY_ACTIVATE_1X_TIMER_INFO = 2096,             /* lte????????VoLTE??????????????????????????1x?????????????????? */

/* 2094 */      en_NV_Item_CTCC_DUAL_MODE_CARD_PLMN_INFO = 2097,                  /* ??????????IMSI???? */

/* 2098 */      en_NV_Item_CL_SYS_ACQ_TYPE_CTRL_CFG = 2098,

/* 2099 */      en_NV_Item_LTE_DO_CONN_INTERUPT_1X_SYS_ACQ_CFG = 2099,         /* ????????srlte????do????LTE????????????????1x???????? */

/* 2100 */      en_NV_Item_CHINA_BOUNDARY_SID_AND_MCC_INFO = 2100,              /* ??????????????????????????SID ?? MCC ???? */

/* 2099 */      en_NV_Item_CL_VOLTE_CFG_INFO       = 2101,

/* 2102 */      en_NV_Item_CDMAMODEMSWITCH_NOT_RESET_CFG   = 2102,              /* ????????CDMAMODEMSWITCH??????????????????????????????????????RESET MODEM */

/* 2103 */      en_NV_Item_CHINA_HOME_SID_AND_MCC_INFO = 2103,                  /* ??????????????????SID ?? MCC ???????????????????????? */

/* 2104 */      en_NV_Item_1X_MT_SMS_TCH_RELEASE_CFG       = 2104,              /* ??????????????????????????????????????????UE????????????????????????????UE???????????????? */
...
/*   2317 */     en_NV_Item_CC_T303_Len_Cfg  = 2317,           /* T303??????????????????30~255?????????? */
...
/*  2333 */     en_NV_Item_Roam_Plmn_Selection_Sort_Cfg     = 2333,             /* ????????????????????NV,????NV????????????????????????????DUO?????????????? */
...
/*  2336 */     en_NV_Item_Ipv6_Address_Test_Mode_Cfg = 2336,                   /* IPV6??????????????????0x55AA55AA???????????????????????????? */

/*  2337 */     en_NV_Item_ADS_IPF_MODE_CFG = 2337,                             /* IPF????ADS?????????????????? */
...
/*  2355 */     en_NV_Item_CS_REG_FAIL_FORB_LA_TIME_CFG                = 2355,  /* cs??????????????LA????FORB LA???????? */

/*  2356 */     en_NV_Item_Add_EHPLMN_WHEN_SRCH_HPLMN_CFG = 2356,               /* ????HPLMN??????EHPLMN ???? */
...
/*  2359  */    en_NV_Item_PROGRESS_INDICATOR_START_T310_INFO   = 2359,         /* ??progress indicator ??#1??#2, #64????????????T310 */
...
/* 2367 */      en_NV_Item_KEEP_CS_FORB_INFO_WHEN_PS_REG_SUCC_CFG = 2367,              /* PS??????????????????FORB?????????? */
...
/* 2374 */      en_NV_Item_REFRESH_USIM_DELAY_RESTART_CFG      = 2374,          /* ????refresh??????????????????????????????????????????????modem */

/* 2375 */      en_NV_EMC_CS_TO_IMS_REDIAL_CFG = 2375,                          /* CS????????????IMS??????NV */

/* 2376 */      en_NV_Item_OTA_SECURITY_SMS_CFG  = 2376,         /* ??????????OTA?????????????? */

/* 2377 */      en_NV_Item_User_Cfg_Forb_Plmn_Info          = 2377,             /* ??????????Forb Plmn???? */

/* 2378 */      en_NV_Item_Cause18_Enable_Lte_Support_Flg          = 2378,             /* LTE????Cause18??????????????Enable LTE */

/* 2379 */      en_NV_Item_RPM_Config   = 2379,                                 /* RPM???????? */

/* 2380 */      en_NV_Item_EXTEND_T3240_LEN_CFG     = 2380,                     /* T3240???????? */

/* 2381 */      en_NV_Item_Cs_Loci                          = 2381,             /* ????CS????????????tmsi, LAI,RAU ???????? */

/* 2382 */      en_NV_Item_Custom_Supplement_Oplmn_Info     = 2382,             /* ??????????oPlmn???? */
/*  2383 */     en_NV_Item_AI_MODEM_CFG     = 2383,                            /* Sensor Hub???????? */

/* 2384 */      en_NV_Item_Trig_Resel_Disconnect_Cause_Cfg = 2384,  /* ????????AS??????????????disconnet?????? */
...
/* 2414 */      en_NV_Item_Srvcc_Sn_Modulo_Cfg = 2414,                          /* SRVCC??G??SN?????? */
...
/* 2421 */      en_NV_Item_Rnic_Net_If_Cfg = 2421,                              /* RNIC??????????Linux???????????????????????? */

/* 2422 */      en_NV_Item_Smsp_Preseted              = 2422,                   /* NV???????????? */

/* 2423 */      en_NV_Item_T3396_Running_Disable_Lte_Cfg = 2423,                /* LMM->MMC attach ind????????????T3396????????????disable lte?????? */

/* 2424 */      en_NV_Item_Telcel_Pdp_Act_Limit_Cfg         = 2424,             /* PDP???????????? */

/*  2425 */      en_NV_Item_Deact_Emc_Pdn_Policy        = 2425,                 /* ????????PDN????GU?????????????? */

/* 2426 */      en_NV_Item_ImsCall_To_CsRedial_Cfg     = 2426,

/* 2427 */      en_NV_Item_Match_Register_Apn_Cfg         = 2427,               /* ??????????????????????APN??????LTE????????APN */

/* 2428 */      en_NV_Item_Nas_Log_Print_Cfg  = 2428,

/* 2429 */      en_NV_Item_Limited_Service_Status_Report_cfg = 2429,

/* 2430 */      en_NV_Item_Tmsi_Or_P_Tmsi_Realloc_Plmn_Valid_Cfg  = 2430,             /* TMSI??P_TMSI????????PLMN??0???????????? */

/* 2432 */      en_NV_Item_EMC_Bar_Trigger_Plmn_Search_Cfg = 2432,              /* EMC??bar?????????????????? */
...
/* 2437 */      en_NV_Item_AT_CLIENT_CFG             = 2437,                    /* ????????????AT????????????Modem???? */

/* 2439 */      en_NV_Item_Emc_Cate_Support_ECALL_CFG             = 2439,       /* ??????SETUP????????????????ECALL???? */
...
/* 2445 */      en_NV_Item_Smc_Fail_Csfb_Mt_Force_Auth_Cfg  = 2445,                 /* SMC FAIL??csfb???????????? ???????? */

/* 2449 */       en_NV_Item_MT_MM_S12_RCV_SYSINFO_CFG             = 2449,
/*  2462 */     en_NV_Item_HIGH_PRIO_PS_CFG                 = 2462,     /* NV_NAS_HIGH_PRIO_PS_CFG_STRU */
/* 2467 */       en_NV_Item_Alerting_Srvcc_Open_Codec_Cfg         = 2467,       /* ????????????????Alerting Srvcc??????????Codec */
/* 2468 */       en_NV_Item_Srvcc_No_Call_Num_T3240_Cfg           = 2468,       /* SRVCC??G????IMSA????????????????????????????????????????????????T3240?????????? */
...
/*   9067 */     en_NV_Item_Report_Cell_Sign              = 9067,/* WAS????NV???????????????????? */
                 en_NV_Item_ETWS_Service_Cfg_Para = 9068,                              /* ETWS ?????????? */
/*   9069*/      en_NV_Item_WAS_Customized_Para        = 9069,       /* WAS????NV????????????NV???? */
...
/* 9092 */       en_NV_Item_Utran_Mode                 = 9092,                  /* ????????UTRAN??????WCDMA????TD-SCDMA */
...
/* 9103 */       en_NV_Item_Utran_Mode_Auto_Switch     = 9103,                  /* ????????GUTL????????????????GUL????,GTL??????????GUTL????????NVIM ID */
/* 9104 */       en_NV_Item_Disabled_Rat_Plmn_Info     = 9104,                  /* ????????????????PLMN???? */

/* Modify by z60575 for multi_ssid, 2012-9-25 begin */
/* 9110 */       en_NV_Item_MULTI_WIFI_KEY             = 9110,       /* ????????SSID????????WIKEY NV?? */
/* 9111 */       en_NV_Item_MULTI_WIFI_STATUS_SSID     = 9111,       /* ????????SSID????????SSID NV?? */
...
/* 9201 */       en_NV_Item_WTTF_MACDL_BBPMST_TB_HEAD_Config  = 9201, /* BBPMST????TB?????? */

/* Added by l60609 for DSDA Phase II, 2012-12-13, Begin */
/* 9202 */       en_NV_Item_AT_CLIENT_CONFIG    = 9202,                           /* ????????????AT????????????Modem???? */
...
/*9215*/         en_NV_Item_THERMAL_HKADC_CONFIG            = 9215, /* ????HKADC????????NV */
/*9216*/         en_NV_Item_HKADC_PHYTOLOGICAL_CONFIG       = 9216, /* ??????????????????????NV */
/*9217*/         en_NV_Item_NV_TCXO_CFG                     = 9217, /* TCXO???????? */

/*9218*/         en_NV_Item_SHARE_PDP_INFO                  = 9218, /* Share PDP????????NV */
/*9219*/         en_NV_Item_DEACT_USIM_WHEN_POWEROFF        = 9219, /* AT+CFUN=0??????????????????SIM??????????NV */
...
/* 9228  */      en_NV_Item_ACC_BAR_PLMN_SEARCH_FLG = 9228,           /*??????HPLMN??RPLMN?????????????????????? */
/* 9229  */      en_NV_Item_USER_CFG_OPLMN_LIST = 9229,               /*????????????OPLMN????????SIM??????????????????SIM?? */
...
/* 9236  */      en_NV_Item_USER_CFG_OPLMN_EXTEND_LIST = 9236,  /*????????????OPLMN????(????256??OPLMN)????SIM??????????????????SIM?? */
...
/*9250*/         en_NV_Item_LTE_DISABLED_USE_LTE_INFO_FLAG = 9250,            /* L????????????gmm??rau????????????l????????????????guti??????????VOS_TRUE:L disable??rau??????l??????????VOS_FALSE:L disable??rau????????l???????? */
/* 9251 */      en_NV_Item_SBM_CUSTOM_DUAL_IMSI        = 9251,       /* WAS????NV??????????????imsi?????????????? */
...
/* 9262 */       en_NV_Item_GSM_SSC_CONFIG_PARA              = 9262,      /* GSM SSC????NV????????  */
...
/* 9272 */       en_NV_Item_ROAMING_REJECT_NORETRY_CFG  = 9272,   /* ????NV: Other Plmn??????reject 17???????? */

/* 9274  */      en_NV_Item_GSM_PCH_DUMMY_DETECT_FLAG    = 9274,

/* ATA????????????????OK NV??????????????????????connect????
   ??????connect ack??????ok????????????????????????connect ack??????ok*/
/* 9276 */     en_NV_Item_Ata_Report_Ok_Async_Cfg = 9276,

/* 9278  */     en_NV_Item_W_HARQ_OUT_CONFIG = 9278,

/* 9279 */       en_NV_Item_W_Drx_Ctrl                  = 9279,         /* WCDMA????????DRX?????????? */
/* 9280 */       en_NV_Item_GSM_Drx_Ctrl                = 9280,         /* GSM????????DRX?????????? */
